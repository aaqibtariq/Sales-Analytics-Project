...
AND DEA_INTERNAL_EMAIL IS NULL;

SELECT COUNT(*)
FROM SILVER.LEADS_ACTIVITIES_SUMMARY
WHERE CUSTOM_ACTIVITY_ID IS NOT NULL
AND CUSTOM_ACTIVITY IS NULL;

SELECT COUNT(*) 
FROM SILVER.LEAD_ACTIVITIES_PROCESSED; -- 1063628

SELECT COUNT(*)
FROM SILVER.LEADS_ACTIVITIES_SUMMARY; -- 1063628
